package org.apache.flex.maps.extras
{
	...
	import org.apache.flex.maps.core.MapExtent;
	 ...
	 */
	[Event(name="copyrightChanged", type="org.apache.flex.maps.events.MapEvent")] 
	public class MapCopyright extends Sprite
	{
					        ...
					        function(provider, cenLat, cenLon, minLat, minLon, maxLat, maxLon, zoom)
					        {
					            switch(provider) {
									...
									case 'HERE_MAP_TERRAIN':
											document.getElementById(this.swfId).copyrightCallback('Nokia HERE.com service');
										 break;
		...
		public function MapCopyright(map:GeoMap, offsetX:Number=10, offsetY:Number=10)
		{
			this.map = map;
