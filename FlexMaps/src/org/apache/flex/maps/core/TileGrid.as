package org.apache.flex.maps.core 
{
	import org.apache.flex.maps.core.painter.ITilePainter;
	import org.apache.flex.maps.core.painter.ITilePainterOverride;
	import org.apache.flex.maps.core.painter.TilePainter;
	...
	public class TileGrid extends Sprite
	{
		...
		*/
		...
		/** 
		 * @protected
		 * <p>figures out from worldMatrix which tiles we should be showing, 
		 * adds them to the stage, adds them to the tileQueue if needed, etc.</p>
		 * 
		 * <p>From my recent testing, TileGrid.onRender takes < 5ms most of the time, and rarely >10ms</p>
		 *
		 *  
		 */
...
import flash.text.TextField;
import org.apache.flex.maps.core.TileGrid;
