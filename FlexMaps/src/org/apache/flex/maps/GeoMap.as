...
package org.apache.flex.maps
{
	...
	import org.apache.flex.maps.events.*;
	import org.apache.flex.maps.geo.*;
	import org.apache.flex.maps.mapproviders.IMapProvider;
	import org.apache.flex.maps.mapproviders.microsoft.MicrosoftProvider;
	import org.apache.flex.maps.overlays.MarkerClip;
    ...
    public class GeoMap extends Sprite
	{
	    ...
	    */
	    public function GeoMap(width:Number=320, height:Number=240, draggable:Boolean=true, mapProvider:IMapProvider=null, ... rest)
	    {
